    ...
    <section id="about" className="bg-card">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="order-2 space-y-4 text-center lg:order-1 lg:text-left animate-in fade-in slide-in-from-left duration-500">
          ...
          <div className="order-1 flex justify-center lg:order-2 animate-in fade-in slide-in-from-right duration-500">
